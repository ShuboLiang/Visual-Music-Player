        ...
        private void Update()
        {
            if (useRoundValue == true)
            {
                if (usePercent == true)
                {
                    ...
                    valueText.text = ((int)mainSlider.value / 60) + ":" + Mathf.Round((mainSlider.value - 60 * ((int)mainSlider.value / 60)));
                    popupValueText.text = ((int)mainSlider.value / 60) + ":" + Mathf.Round((mainSlider.value - 60 * ((int)mainSlider.value / 60)));
                }
                else
                {
                    valueText.text = Mathf.Round(mainSlider.value * 1.0f).ToString();
